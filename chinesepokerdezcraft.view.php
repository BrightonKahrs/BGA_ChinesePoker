 ...
 */
  ...
  class view_chinesepokerdezcraft_chinesepokerdezcraft extends game_view
  {
    function getGameName() {
        return "chinesepokerdezcraft";
    }    
  	...
  	{		
        ...
        $this->page->begin_block( "chinesepokerdezcraft_chinesepokerdezcraft", "player" );
