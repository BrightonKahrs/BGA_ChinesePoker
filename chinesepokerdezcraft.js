...
function (dojo, declare) {
    return declare("bgagame.chinesepokerdezcraft", ebg.core.gamegui, {
        constructor: function(){
            console.log('chinese poker constructor');
        ...
        */
        ...
        onPlayerHandSelectionChanged: function(  )
        {
            ...
            if( items.length > 0 )
            {
                if( this.checkAction( 'playCard', true ) )
                {
                    ...
                    this.ajaxcall( "/chinesepokerdezcraft/chinesepokerdezcraft/playCard.html", { 
                            id: card_id,
                            lock: true 
        ...
        onGiveCards: function()
        {
            if( this.checkAction( 'giveCards' ) )
            {
                ...
                this.ajaxcall( "/chinesepokerdezcraft/chinesepokerdezcraft/giveCards.html", { cards: to_give, lock: true }, this, function( result ) {
                }, function( is_error) { } );                
            }        
        },
